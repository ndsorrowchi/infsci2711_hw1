...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "mingsa"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "mingsa"; // CHANGE TO YOUR MYSQL PASSWORD
